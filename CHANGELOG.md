...
- Добавлены алиасы импортов в deno.json для улучшения читаемости кода
  - `@src/` для импортов из папки src
  - `@shared/` для импортов из общей папки shared
  - Все относительные импорты типа `../../../` заменены на алиасы
